#ifndef STM32LCDRUS_H
#define STM32LCDRUS_H
...
class Stm32LcdRus : public Print {
public:
  Stm32LcdRus(uint8 rs, uint8 enable,
		uint8 d0, uint8 d1, uint8 d2, uint8 d3,
		uint8 d4, uint8 d5, uint8 d6, uint8 d7);
  Stm32LcdRus(uint8 rs, uint8 rw, uint8 enable,
		uint8 d0, uint8 d1, uint8 d2, uint8 d3,
		uint8 d4, uint8 d5, uint8 d6, uint8 d7);
  Stm32LcdRus(uint8 rs, uint8 rw, uint8 enable,
		uint8 d0, uint8 d1, uint8 d2, uint8 d3);
  ...
  void setDRAMModel(uint8);

private:
  void send(uint8, uint8);
  void writeNbits(uint8, uint8);
  uint8 recv(uint8);
  uint8 readNbits(uint8); 
  void pulseEnable();
  ...
  uint8 _dram_model;
  int8 utf_hi_char; // UTF-8 high part
};
